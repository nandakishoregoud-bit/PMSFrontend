...
const AdminTaskScreen = ({ employeeId }) => {
    ...
    const handleSearchEmployee = async () => {
        try {
            ...
            const employee = res.data.find(e => e.empId === searchInput);
            if (!employee) {
    ...
    const submitEdit = async () => {
        ...
        try {
            const response = await axios.put(
                `${BASE_URL}/tasks/${editTaskData.id}/update`,
        ...
        return (
            <div className="modal-overlay">
                ...
                <div className="modal-content">
                    ...
                    />
                    <button onClick={handleSearchEmployee}>Search & Add</button>
                    {searchError && <p style={{ color: "red" }}>{searchError}</p>}
                    <ul>
                        {assignedEmployees.map((emp) => (
                            <li key={emp.empId}>
                                {emp.empId}
                                <button onClick={() => setAssignedEmployees(assignedEmployees.filter(e => e.empId !== emp.empId))}>Remove</button>
                            </li>
                        ))}
                    </ul>
